...
const Dashboard = () => {
  ...
  const fetchDashboardData = async () => {
   try {
      ...
      const url = backendUrl.endsWith('/') ? backendUrl + 'api/educator/dashboard' : backendUrl + '/api/educator/dashboard';
    ...
    <div className="min-h-screen flex flex-col items-start justify-between gap-8 md:p-8 md:pb-0 p-4 pt-8 pb-0">
      <div className="space-y-5">
        <div className="flex flex-wrap gap-5 items-center">
          ...
          <div className="flex items-center gap-3 shadow-card border border-blue-500 p-4 w-56 rounded-md">
            <img src={assets.appointments_icon} alt="course icon" />
            <div>
              <p className="text-2xl font-medium text-gray-600">
        ...
        <div>
          ...
          <div className="flex flex-col items-center max-w-4xl w-full overflow-hidden rounded-md bg-white border border-b-gray-500/20">
