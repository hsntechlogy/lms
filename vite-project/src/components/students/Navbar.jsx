...
const Navbar = () => {
  ...
  const becomeEducator = async () => {
   ...
   return (
    <div className={`flex items-center justify-between px-4 sm:px-10 md:px-14 lg:px-36 border-b border-gray-500 py-4 ${isCourseListPage ? 'bg-blue-50' : 'bg-cyan-100/70'}`}>
